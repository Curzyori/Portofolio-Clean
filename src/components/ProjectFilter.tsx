        ...
        {p.links.map((link, idx) => {
          ...
          if (link.type === "web") {
            return (
              ...
              >
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                </svg>
                <span>{link.label || "Website"}</span>
              </a>
            );
          }
          ...
          if (link.type === "contact") {
            return (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-purple-500 hover:bg-purple-600 text-white text-xs font-mono transition-colors"
              >
                <svg className="w-3.5 h-3.5 fill-none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                </svg>
                <span>{link.label || "Contact"}</span>
              </a>
            );
          }
          return null;
